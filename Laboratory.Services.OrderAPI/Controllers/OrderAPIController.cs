...
namespace Laboratory.Services.OrderAPI.Controllers
{
    ...
    public class OrderAPIController : ControllerBase
    {
       ...
       // private readonly IMessageBus _messageBus;
        ...
        public OrderAPIController(AppDbContext db,
            ITestService testService, IMapper mapper, IConfiguration configuration)
        {
            _db = db;
     ...
     //   [Authorize]
        ...
        public async Task<ResponseDto> UpdateOrder([FromBody] CartDto cartDto)
        {
            try
            {
                ...
                orderHeaderDto.OrderDetails = _mapper.Map<IEnumerable<OrderDetailsDto>>(cartDto.CartDetails);
                orderHeaderDto.OrderTotal = Math.Round(orderHeaderDto.OrderTotal, 2);
                OrderHeader orderUpdated = _db.OrderHeaders.Update(_mapper.Map<OrderHeader>(orderHeaderDto)).Entity;
                await _db.SaveChangesAsync();
